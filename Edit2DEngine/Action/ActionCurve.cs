...
namespace Edit2DEngine.Action
{
    public class ActionCurve : ActionBase
    {
        ...
        //Entite entiteCloneAnimation;
        Object entiteCloneAnimation;
        ...
        public void StopAnimation()
        {
            if (playAnimationState > 0)
            {
                ...
                {
                    case "Size":
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (Size)this.ActionProperty.GetValue(entiteCloneAnimation, null), null);
                        break;
                    case "Vector2":
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (Vector2)this.ActionProperty.GetValue(entiteCloneAnimation, null), null);
                        break;
                    case "Single":
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (float)this.ActionProperty.GetValue(entiteCloneAnimation, null), null);
                        break;
                    case "Color":
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (Microsoft.Xna.Framework.Graphics.Color)this.ActionProperty.GetValue(entiteCloneAnimation, null), null);
                        break;
                    default:
                        break;
                }
        ...
        public void StartAnimation(PlayAnimationState state)
        {
            ...
            if (this.Script.ActionHandler is Entite)
                entiteCloneAnimation = ((Entite)this.Script.ActionHandler).Clone();
            else if (this.Script.ActionHandler is ParticleSystem)
                entiteCloneAnimation = ((ParticleSystem)this.Script.ActionHandler).Clone();
        ...
        public void UpdateAnimation(int timeLine)
        {
            ...
            switch (this.PropertyType.Name)
            {
                case "Size":
                    if (this.IsRelative)
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (Size)this.ActionProperty.GetValue(entiteCloneAnimation, null) + sizeValue, null);
                    else
                        this.ActionProperty.SetValue(this.Script.ActionHandler, sizeValue, null);
                    break;
                case "Vector2":
                    if (this.IsRelative)
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (Vector2)this.ActionProperty.GetValue(entiteCloneAnimation, null) + vector2Value, null);
                    else
                        this.ActionProperty.SetValue(this.Script.ActionHandler, vector2Value, null);
                    break;
                case "Single":
                    if (this.IsRelative)
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (float)this.ActionProperty.GetValue(entiteCloneAnimation, null) + floatValue, null);
                    else
                        this.ActionProperty.SetValue(this.Script.ActionHandler, floatValue, null);
                    break;
                case "Int32":
                    if (this.IsRelative)
                        this.ActionProperty.SetValue(this.Script.ActionHandler, (int)this.ActionProperty.GetValue(entiteCloneAnimation, null) + (int)floatValue, null);
                    else
                ...
                case "Color":
                    ...
                    //if (this.IsRelative)
                    //    this.ActionProperty.SetValue(this.Script.Entite, (Microsoft.Xna.Framework.Graphics.Color)this.ActionProperty.GetValue(entiteCloneAnimation, null) + colorValue, null);
                    //else
