...
namespace Xna.Tools
{
    ...
    public class EditCurve
    {
        ...
        #region Constructors
        public EditCurve(string name, Color curveColor, CommandHistory commandHistory)
        {
        ...
        public EditCurve(string name, Color curveColor, Curve curve,
        ...
        public static EditCurve LoadFromFile(string filename, string name,
                                            Color color, CommandHistory commandHistory)
        {
