    ...
    public class TriggerValueChanged : TriggerBase
    {
        ...
        public Object Value
        {
            ...
            set
            {
                ...
                {
                    sizeValue = (System.Drawing.Size)value;
                }
                else if (this.PropertyType.Name == "Color")
                {
        ...
        private System.Drawing.Size sizeValue;
                ...
                switch (this.Sens[i])
                {
                    case TriggerValueChangedSens.Superior:
                        switch (this.PropertyType.Name)
                        {
                            ...
                            case "Color":
                                if (i == 0)
                                    launchTrigger &= (((Color)this.TriggerProperty.GetValue(this.Entite, null)).R > colorValue.R);
                                else if (i == 1)
                                    launchTrigger &= (((Color)this.TriggerProperty.GetValue(this.Entite, null)).G > colorValue.G);
                                else if (i == 2)
                                    launchTrigger &= (((Color)this.TriggerProperty.GetValue(this.Entite, null)).B > colorValue.B);
                                else if (i == 3)
                                    launchTrigger &= (((Color)this.TriggerProperty.GetValue(this.Entite, null)).A > colorValue.A);
                                break;
